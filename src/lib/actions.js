...
// --- HELPER FUNCTIONS ---
async function sendToWeb3Forms(data, subject) {
  if (WEB3FORMS_ACCESS_KEY === 'YOUR_WEB3FORMS_ACCESS_KEY') {
    console.warn("Web3Forms access key is not set. Please update src/lib/actions.js.");
 ...
 * @param formData - The form data.
 */
export async function handleMerchOrder(prevState, formData) {
